...
suite='SIMBA' #IllustrisTNG,SIMBA
...
for j in simulations:
    for k in snap:
        ...
        print('python', 'search_rad.py',k,suite,j,file=open(g,'a'))
        #print('python', 'profiles_expand_test.py',prof1,prof2,prof3,prof4,prof5,prof6,prof7,prof8,prof9,k,sim,j,file=open(g,'a'))
        start=time.time()
